...
bool ToggleController::handleRequest(
    ...
    try {
        ...
        bool isOn;
        ThrowIfNot(carControlService->isToggleControllerOn(endpoint->getId(), getInstance(), isOn), "Platform interface 'turnToggleControllerOn' failed");
        setPropertyValue(isOn);
