...
package com.amazon.aace.localNavigation;
 ...
 */
public abstract class LocalSearchProvider extends PlatformInterface {
    /**
     ...
     */
    public abstract boolean poiSearchRequest(final String request);
     ...
     */
    public abstract boolean poiLookupRequest(final String request);
     ...
     */
    public final void poiSearchResponse(final String response) {
        poiSearchResponse(getNativeRef(), response);
    }
     ...
     */
    public final void poiLookupResponse(final String response) {
        poiLookupResponse(getNativeRef(), response);
    }

    protected final long createNativeRef() {
        return createBinder();
    }

    protected final void disposeNativeRef(long nativeRef) {
    ...
    private native void poiSearchResponse(long nativeRef, String response);
    private native void poiLookupResponse(long nativeRef, String response);
}